...
void setup()
{
 ...
 pinMode(1, INPUT_PULLUP); // przycisk stopu
 pinMode(2, INPUT_PULLUP); // przycisk kierunkowskazu
 pinMode(3, INPUT_PULLUP); // przycisk wstecznego
 pinMode(4, INPUT_PULLUP); // przyciek przeciwmieglncyh 
